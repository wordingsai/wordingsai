    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "size-9 p-0 select-none aria-disabled:opacity-50 hover:bg-primary/10 hover:text-primary transition-colors",
        ...
        dropdown_root: cn(
          "relative flex items-center justify-center rounded-lg border border-outline-variant bg-surface-container-low hover:bg-surface-container transition-colors px-3 py-1 text-on-surface-variant font-bold",
