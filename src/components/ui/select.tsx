    ...
    <SelectPrimitive.Portal>
      ...
      >
        <SelectPrimitive.Popup
          ...
          className={cn(
            "relative isolate z-50 max-h-(--available-height) w-(--anchor-width) overflow-y-auto rounded-xl bg-popover/90 backdrop-blur border border-border text-foreground shadow-xl",
            className,
          )}
          {...props}
        >
